...
public class DeletedFilesPage extends BasePage{
    ...
    @FindBy(xpath = "//tbody/tr[1]/td[2]//span[@class='icon icon-more']")
    public WebElement firstLine3Dots;

    @FindBy(xpath = "//li//span[contains(text(),'Delete ')]")
    public WebElement deleteFileLink;

    @FindBy(xpath = "//tbody/tr[1]/td[2]//span[@class='innernametext']")
    public WebElement firstLineName;

    @FindBy(xpath = "//tbody/tr[1]/td[2]//span[@class='nametext extra-data']//span[@class='innernametext']")
    ...
    @FindBy(xpath = "//a[.='Deleted']/../../../..//tbody/tr")
